...
const data = new DataManager({
  ...
  removeUrl: baseUrl + "/deletedPrerada/delete",
  url: baseUrl + "/deletedPrerada",
});
...
const RadDatagrid = () => {
  ...
  async function commandClick(args) {
    await retrieveDeleted("Prerada", args.rowData).then((resp) =>
      console.log(resp)
    );
    grid.refresh();
  }
